# Django settings for mainlogin project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mainlogin',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'mainlogin.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mainlogin.wsgi.application'
